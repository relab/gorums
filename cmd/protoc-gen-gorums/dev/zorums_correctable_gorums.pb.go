...
// Correctable plain.
func (c *ZorumsServiceConfiguration) Correctable(ctx context.Context, in *Request) *CorrectableResponse {
...
func (c *ZorumsServiceConfiguration) CorrectablePerNodeArg(ctx context.Context, in *Request, f func(*Request, uint32) *Request) *CorrectableResponse {
	cd := gorums.CorrectableCallData{
		Message:      in,
...
func (c *ZorumsServiceConfiguration) CorrectableCustomReturnType(ctx context.Context, in *Request) *CorrectableMyResponse {
	cd := gorums.CorrectableCallData{
		Message:      in,
...
func (c *ZorumsServiceConfiguration) CorrectableCombo(ctx context.Context, in *Request, f func(*Request, uint32) *Request) *CorrectableMyResponse {
	cd := gorums.CorrectableCallData{
		Message:      in,
...
func (c *ZorumsServiceConfiguration) CorrectableStream(ctx context.Context, in *Request) *CorrectableStreamResponse {
	cd := gorums.CorrectableCallData{
		Message:      in,
...
// CorrectablePerNodeArg with per_node_arg option.
func (c *ZorumsServiceConfiguration) CorrectableStreamPerNodeArg(ctx context.Context, in *Request, f func(*Request, uint32) *Request) *CorrectableStreamResponse {
	cd := gorums.CorrectableCallData{
		Message:      in,
...
// CorrectableCustomReturnType with custom_return_type option.
func (c *ZorumsServiceConfiguration) CorrectableStreamCustomReturnType(ctx context.Context, in *Request) *CorrectableStreamMyResponse {
	cd := gorums.CorrectableCallData{
		Message:      in,
...
// CorrectableCombo with all supported options.
func (c *ZorumsServiceConfiguration) CorrectableStreamCombo(ctx context.Context, in *Request, f func(*Request, uint32) *Request) *CorrectableStreamMyResponse {
	cd := gorums.CorrectableCallData{
		Message:      in,
...
// CorrectableEmpty for testing imported message type.
func (c *ZorumsServiceConfiguration) CorrectableStreamEmpty(ctx context.Context, in *Request) *CorrectableStreamEmpty {
	cd := gorums.CorrectableCallData{
		Message:      in,
