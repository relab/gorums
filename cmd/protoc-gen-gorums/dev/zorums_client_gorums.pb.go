...
type ZorumsServiceClient interface {
	...
	BroadcastWithClientHandler1(ctx context.Context, in *Request, cancelOnTimeout ...bool) (resp *Response, err error)
	BroadcastWithClientHandler2(ctx context.Context, in *Request, cancelOnTimeout ...bool) (resp *Response, err error)
	BroadcastWithClientHandlerAndBroadcastOption(ctx context.Context, in *Request, cancelOnTimeout ...bool) (resp *Response, err error)
