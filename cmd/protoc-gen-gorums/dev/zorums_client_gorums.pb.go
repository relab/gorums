...
type ZorumsServiceClient interface {
	...
	MulticastWithBroadcast(ctx context.Context, in *Request, opts ...gorums.CallOption)
...
type ZorumsServiceNodeClient interface {
	...
	BroadcastInternal(ctx context.Context, in *Request) (resp *emptypb.Empty, err error)
	BroadcastWithClientHandler1(ctx context.Context, in *Request) (resp *Response, err error)
	BroadcastWithClientHandler2(ctx context.Context, in *Request) (resp *Response, err error)
	BroadcastWithClientHandlerAndBroadcastOption(ctx context.Context, in *Request) (resp *Response, err error)
