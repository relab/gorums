...
type ZorumsServiceClient interface {
	QuorumCall(ctx context.Context, in *Request) iter.Seq2[*Response, error]
	QuorumCallPerNodeArg(ctx context.Context, in *Request, f func(*Request, uint32) *Request) iter.Seq2[*Response, error]
	QuorumCallCustomReturnType(ctx context.Context, in *Request) iter.Seq2[*MyResponse, error]
	QuorumCallCombo(ctx context.Context, in *Request, f func(*Request, uint32) *Request) iter.Seq2[*MyResponse, error]
	QuorumCallEmpty(ctx context.Context, in *emptypb.Empty) iter.Seq2[*Response, error]
	QuorumCallEmpty2(ctx context.Context, in *Request) iter.Seq2[*emptypb.Empty, error]
