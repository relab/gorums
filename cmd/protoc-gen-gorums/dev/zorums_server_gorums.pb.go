...
func (srv *Server) QuorumCallEmpty(ctx gorums.ServerCtx, request *emptypb.Empty) (response *Response, err error) {
	panic(status.Errorf(codes.Unimplemented, "method QuorumCallEmpty not implemented"))
}
func (srv *Server) QuorumCallEmpty2(ctx gorums.ServerCtx, request *Request) (response *emptypb.Empty, err error) {
...
func (srv *Server) Multicast4(ctx gorums.ServerCtx, request *emptypb.Empty) {
...
func (srv *Server) QuorumCallAsyncEmpty(ctx gorums.ServerCtx, request *Request) (response *emptypb.Empty, err error) {
	panic(status.Errorf(codes.Unimplemented, "method QuorumCallAsyncEmpty not implemented"))
}
func (srv *Server) QuorumCallAsyncEmpty2(ctx gorums.ServerCtx, request *emptypb.Empty) (response *Response, err error) {
...
func (srv *Server) CorrectableEmpty(ctx gorums.ServerCtx, request *Request) (response *emptypb.Empty, err error) {
	panic(status.Errorf(codes.Unimplemented, "method CorrectableEmpty not implemented"))
}
func (srv *Server) CorrectableEmpty2(ctx gorums.ServerCtx, request *emptypb.Empty) (response *Response, err error) {
...
func (srv *Server) CorrectableStreamEmpty(ctx gorums.ServerCtx, request *Request, send func(response *emptypb.Empty) error) error {
	panic(status.Errorf(codes.Unimplemented, "method CorrectableStreamEmpty not implemented"))
}
func (srv *Server) CorrectableStreamEmpty2(ctx gorums.ServerCtx, request *emptypb.Empty, send func(response *Response) error) error {
...
func RegisterZorumsServiceServer(srv *Server, impl ZorumsServiceServer) {
