...
type QuorumSpec[idType cmp.Ordered] interface {
	...
	QuorumCallQF(in *Request, replies map[idType]*Response) (*Response, bool)
	...
	// be used by the quorum function. If the in parameter is not needed
	// you should implement your quorum function with '_ *Request'.
	QuorumCallPerNodeArgQF(in *Request, replies map[idType]*Response) (*Response, bool)
	...
	// be used by the quorum function. If the in parameter is not needed
	// you should implement your quorum function with '_ *Request'.
	QuorumCallCustomReturnTypeQF(in *Request, replies map[idType]*Response) (*MyResponse, bool)
	...
	// be used by the quorum function. If the in parameter is not needed
	// you should implement your quorum function with '_ *Request'.
	QuorumCallComboQF(in *Request, replies map[idType]*Response) (*MyResponse, bool)
	...
	QuorumCallEmptyQF(in *emptypb.Empty, replies map[idType]*Response) (*Response, bool)
	...
	// be used by the quorum function. If the in parameter is not needed
	// you should implement your quorum function with '_ *Request'.
	QuorumCallEmpty2QF(in *Request, replies map[idType]*emptypb.Empty) (*emptypb.Empty, bool)
	...
	// be used by the quorum function. If the in parameter is not needed
	// you should implement your quorum function with '_ *Request'.
	QuorumCallAsyncQF(in *Request, replies map[idType]*Response) (*Response, bool)
	...
	// be used by the quorum function. If the in parameter is not needed
	// you should implement your quorum function with '_ *Request'.
	QuorumCallAsyncPerNodeArgQF(in *Request, replies map[idType]*Response) (*Response, bool)
	...
	// be used by the quorum function. If the in parameter is not needed
	// you should implement your quorum function with '_ *Request'.
	QuorumCallAsyncCustomReturnTypeQF(in *Request, replies map[idType]*Response) (*MyResponse, bool)
	...
	// be used by the quorum function. If the in parameter is not needed
	// you should implement your quorum function with '_ *Request'.
	QuorumCallAsyncComboQF(in *Request, replies map[idType]*Response) (*MyResponse, bool)
	...
	// be used by the quorum function. If the in parameter is not needed
	// you should implement your quorum function with '_ *Request'.
	QuorumCallAsync2QF(in *Request, replies map[idType]*Response) (*Response, bool)
	...
	// be used by the quorum function. If the in parameter is not needed
	// you should implement your quorum function with '_ *Request'.
	QuorumCallAsyncEmptyQF(in *Request, replies map[idType]*emptypb.Empty) (*emptypb.Empty, bool)
	...
	// be used by the quorum function. If the in parameter is not needed
	// you should implement your quorum function with '_ *emptypb.Empty'.
	QuorumCallAsyncEmpty2QF(in *emptypb.Empty, replies map[idType]*Response) (*Response, bool)
	...
	// be used by the quorum function. If the in parameter is not needed
	// you should implement your quorum function with '_ *Request'.
	CorrectableQF(in *Request, replies map[idType]*Response) (*Response, int, bool)
	...
	// be used by the quorum function. If the in parameter is not needed
	// you should implement your quorum function with '_ *Request'.
	CorrectablePerNodeArgQF(in *Request, replies map[idType]*Response) (*Response, int, bool)
	...
	// be used by the quorum function. If the in parameter is not needed
	// you should implement your quorum function with '_ *Request'.
	CorrectableCustomReturnTypeQF(in *Request, replies map[idType]*Response) (*MyResponse, int, bool)
	...
	// be used by the quorum function. If the in parameter is not needed
	// you should implement your quorum function with '_ *Request'.
	CorrectableComboQF(in *Request, replies map[idType]*Response) (*MyResponse, int, bool)
	...
	// be used by the quorum function. If the in parameter is not needed
	// you should implement your quorum function with '_ *Request'.
	CorrectableEmptyQF(in *Request, replies map[idType]*emptypb.Empty) (*emptypb.Empty, int, bool)
	...
	// be used by the quorum function. If the in parameter is not needed
	// you should implement your quorum function with '_ *emptypb.Empty'.
	CorrectableEmpty2QF(in *emptypb.Empty, replies map[idType]*Response) (*Response, int, bool)
	...
	// be used by the quorum function. If the in parameter is not needed
	// you should implement your quorum function with '_ *Request'.
	CorrectableStreamQF(in *Request, replies map[idType]*Response) (*Response, int, bool)
	...
	// be used by the quorum function. If the in parameter is not needed
	// you should implement your quorum function with '_ *Request'.
	CorrectableStreamPerNodeArgQF(in *Request, replies map[idType]*Response) (*Response, int, bool)
	...
	// be used by the quorum function. If the in parameter is not needed
	// you should implement your quorum function with '_ *Request'.
	CorrectableStreamCustomReturnTypeQF(in *Request, replies map[idType]*Response) (*MyResponse, int, bool)
	...
	// be used by the quorum function. If the in parameter is not needed
	// you should implement your quorum function with '_ *Request'.
	CorrectableStreamComboQF(in *Request, replies map[idType]*Response) (*MyResponse, int, bool)
	...
	// be used by the quorum function. If the in parameter is not needed
	// you should implement your quorum function with '_ *Request'.
	CorrectableStreamEmptyQF(in *Request, replies map[idType]*emptypb.Empty) (*emptypb.Empty, int, bool)
	...
	// be used by the quorum function. If the in parameter is not needed
	// you should implement your quorum function with '_ *emptypb.Empty'.
	CorrectableStreamEmpty2QF(in *emptypb.Empty, replies map[idType]*Response) (*Response, int, bool)
}
