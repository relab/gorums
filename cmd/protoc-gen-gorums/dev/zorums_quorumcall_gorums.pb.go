...
// QuorumCall plain.
func (c *ZorumsServiceConfiguration) QuorumCall(ctx context.Context, in *Request) (resp *Response, err error) {
...
func (c *ZorumsServiceConfiguration) QuorumCallPerNodeArg(ctx context.Context, in *Request, f func(*Request, uint32) *Request) (resp *Response, err error) {
	cd := gorums.QuorumCallData{
		Message: in,
...
func (c *ZorumsServiceConfiguration) QuorumCallCustomReturnType(ctx context.Context, in *Request) (resp *MyResponse, err error) {
	cd := gorums.QuorumCallData{
		Message: in,
...
func (c *ZorumsServiceConfiguration) QuorumCallCombo(ctx context.Context, in *Request, f func(*Request, uint32) *Request) (resp *MyResponse, err error) {
	cd := gorums.QuorumCallData{
		Message: in,
...
func (c *ZorumsServiceConfiguration) QuorumCallEmpty(ctx context.Context, in *emptypb.Empty) (resp *Response, err error) {
	cd := gorums.QuorumCallData{
		Message: in,
...
func (c *ZorumsServiceConfiguration) QuorumCallEmpty2(ctx context.Context, in *Request) (resp *emptypb.Empty, err error) {
	cd := gorums.QuorumCallData{
		Message: in,
