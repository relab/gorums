...
const file_zorums_proto_rawDesc = "" +
	...
	"\n" +
	"MyResponse\x12\x14\n" +
	"\x05Value\x18\x01 \x01(\tR\x05Value2\xae\x14\n" +
	"\rZorumsService\x12)\n" +
	...
	"\x17QuorumCallWithBroadcast\x12\f.dev.Request\x1a\r.dev.Response\"\b\xa0\xb5\x18\x01\x90\xb8\x18\x01\x12H\n" +
	"\x16MulticastWithBroadcast\x12\f.dev.Request\x1a\x16.google.protobuf.Empty\"\b\x98\xb5\x18\x01\x90\xb8\x18\x01\x12?\n" +
	"\x11BroadcastInternal\x12\f.dev.Request\x1a\x16.google.protobuf.Empty\"\x04\x90\xb8\x18\x01\x12@\n" +
	"\x1bBroadcastWithClientHandler1\x12\f.dev.Request\x1a\r.dev.Response\"\x04\xb0\xb5\x18\x01\x12@\n" +
	"\x1bBroadcastWithClientHandler2\x12\f.dev.Request\x1a\r.dev.Response\"\x04\xb0\xb5\x18\x01\x12U\n" +
	",BroadcastWithClientHandlerAndBroadcastOption\x12\f.dev.Request\x1a\r.dev.Response\"\b\xb0\xb5\x18\x01\x90\xb8\x18\x01\x12.\n" +
