...
var manager = managerVariables +
	managerServicesBegin +
	managerStructs + managerConstructor + managerNewConfiguration + managerMethodNodes +
	managerServicesEnd
