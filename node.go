...
//
// Use the [Latency] comparator with [Config.SortBy] to order nodes
...
// It is compatible with [slices.SortFunc] and [Config.SortBy].
...
// measurement. It is compatible with [slices.SortFunc] and [Config.SortBy].
