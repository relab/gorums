...
var file_gorums_proto_extTypes = []protoimpl.ExtensionInfo{
	{
		...
		Field:         50001,
		Name:          "gorums.remotecall",
		Tag:           "varint,50001,opt,name=remotecall",
...
var (
	// call types
	//
	// optional bool remotecall = 50001;
	E_Remotecall = &file_gorums_proto_extTypes[0] // only for internal use; no need to set manually
...
var file_gorums_proto_depIdxs = []int32{
	0, // 0: gorums.remotecall:extendee -> google.protobuf.MethodOptions
