...
type Metadata struct {
	...
	xxx_hidden_MsgType      uint32                 `protobuf:"varint,6,opt,name=msg_type,json=msgType"`
...
func (x *Metadata) GetPayload() []byte {
	if x != nil {
...
func (x *Metadata) GetMsgType() uint32 {
	if x != nil {
		return x.xxx_hidden_MsgType
	}
	return 0
}
...
func (x *Metadata) SetPayload(v []byte) {
	if v == nil {
		v = []byte{}
	}
...
func (x *Metadata) SetMsgType(v uint32) {
	x.xxx_hidden_MsgType = v
}
...
func (b0 Metadata_builder) Build() *Metadata {
	...
	x.xxx_hidden_MsgType = b.MsgType
	return m0
}
