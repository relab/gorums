...
// QuorumSpec is the interface of quorum functions for Sample.
...
// Sample is the server-side API for the Sample Service
type Sample interface {
	WriteQC(ctx gorums.ServerCtx, request *WriteRequest) (response *WriteResponse, err error)
}

func RegisterSampleServer(srv *gorums.Server, impl Sample) {
	srv.RegisterHandler("all2all.Sample.WriteQC", func(ctx gorums.ServerCtx, in *gorums.Message, finished chan<- *gorums.Message) {
