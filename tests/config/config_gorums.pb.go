...
type QuorumSpec[idType cmp.Ordered] interface {
	...
	ConfigQF(in *Request, replies map[idType]*Response) (*Response, bool)
}

// Config is a quorum call invoked on all nodes in configuration c,
// with the same argument in, and returns a combined result.
func (c *Configuration[idType]) Config(ctx context.Context, in *Request) (resp *Response, err error) {
