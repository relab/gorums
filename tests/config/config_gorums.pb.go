...
func (srv *Server) Config(ctx gorums.ServerCtx, request *Request) (response *Response, err error) {
	panic(status.Errorf(codes.Unimplemented, "method Config not implemented"))
}

func RegisterConfigTestServer(srv *Server, impl ConfigTestServer) {
