...
func (srv *Server) IDFromMD(ctx gorums.ServerCtx, request *emptypb.Empty) (response *NodeID, err error) {
	panic(status.Errorf(codes.Unimplemented, "method IDFromMD not implemented"))
}
func (srv *Server) WhatIP(ctx gorums.ServerCtx, request *emptypb.Empty) (response *IPAddr, err error) {
	panic(status.Errorf(codes.Unimplemented, "method WhatIP not implemented"))
}

func RegisterMetadataTestServer(srv *Server, impl MetadataTestServer) {
