...
func (srv *Server) UseReq(ctx gorums.ServerCtx, request *Request) (response *Response, err error) {
	panic(status.Errorf(codes.Unimplemented, "method UseReq not implemented"))
}
func (srv *Server) IgnoreReq(ctx gorums.ServerCtx, request *Request) (response *Response, err error) {
	panic(status.Errorf(codes.Unimplemented, "method IgnoreReq not implemented"))
}

func RegisterQuorumFunctionServer(srv *Server, impl QuorumFunctionServer) {
