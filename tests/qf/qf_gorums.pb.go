...
type QuorumFunctionClient interface {
	UseReq(ctx context.Context, in *Request) gorums.Iterator[*Response]

	IgnoreReq(ctx context.Context, in *Request) gorums.Iterator[*Response]
}
...
func (c *Configuration) UseReq(ctx context.Context, in *Request) gorums.Iterator[*Response] {
...
// with the same argument in, and returns a combined result. test
func (c *Configuration) IgnoreReq(ctx context.Context, in *Request) gorums.Iterator[*Response] {
	cd := gorums.QuorumCallData{
		Message:      in,
