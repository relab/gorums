...
type Dummy interface {
	Test(context.Context, *Empty, func(*Empty, error))
}

func RegisterDummyServer(srv *gorums.Server, impl Dummy) {
	srv.RegisterHandler("dummy.Dummy.Test", func(ctx context.Context, in *gorums.Message, finished chan<- *gorums.Message) {
