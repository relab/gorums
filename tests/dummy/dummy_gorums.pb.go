...
func (srv *Server) Test(ctx gorums.ServerCtx, request *Empty) (response *Empty, err error) {
	panic(status.Errorf(codes.Unimplemented, "method Test not implemented"))
}

func RegisterDummyServer(srv *Server, impl DummyServer) {
