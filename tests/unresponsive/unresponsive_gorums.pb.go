...
func (srv *Server) TestUnresponsive(ctx gorums.ServerCtx, request *Empty) (response *Empty, err error) {
	panic(status.Errorf(codes.Unimplemented, "method TestUnresponsive not implemented"))
}

func RegisterUnresponsiveServer(srv *Server, impl UnresponsiveServer) {
