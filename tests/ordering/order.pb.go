...
const file_ordering_order_proto_rawDesc = "" +
	...
	"\bResponse\x12\x18\n" +
	"\aInOrder\x18\x01 \x01(\bR\aInOrder2\xac\x01\n" +
	"\n" +
	"GorumsTest\x121\n" +
	"\x02QC\x12\x11.ordering.Request\x1a\x12.ordering.Response\"\x04\xa0\xb5\x18\x01\x126\n" +
	"\aQCAsync\x12\x11.ordering.Request\x1a\x12.ordering.Response\"\x04\xa0\xb5\x18\x01\x123\n" +
