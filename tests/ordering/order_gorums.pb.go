...
type GorumsTest interface {
	...
	QCAsync(context.Context, *Request, func(*Response, error))
	UnaryRPC(context.Context, *Request, func(*Response, error))
}

func RegisterGorumsTestServer(srv *gorums.Server, impl GorumsTest) {
	srv.RegisterHandler("ordering.GorumsTest.QC", func(ctx context.Context, in *gorums.Message, finished chan<- *gorums.Message) {
	...
	srv.RegisterHandler("ordering.GorumsTest.QCAsync", func(ctx context.Context, in *gorums.Message, finished chan<- *gorums.Message) {
		req := in.Message.(*Request)
		once := new(sync.Once)
		f := func(resp *Response, err error) {
			once.Do(func() {
	...
	srv.RegisterHandler("ordering.GorumsTest.UnaryRPC", func(ctx context.Context, in *gorums.Message, finished chan<- *gorums.Message) {
		req := in.Message.(*Request)
		once := new(sync.Once)
		f := func(resp *Response, err error) {
			once.Do(func() {
