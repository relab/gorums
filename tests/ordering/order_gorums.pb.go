...
func (c *Configuration[idType]) QCAsync(ctx context.Context, in *Request) *AsyncResponse {
...
type QuorumSpec[idType cmp.Ordered] interface {
	...
	QCQF(in *Request, replies map[idType]*Response) (*Response, bool)
	...
	// be used by the quorum function. If the in parameter is not needed
	// you should implement your quorum function with '_ *Request'.
	QCAsyncQF(in *Request, replies map[idType]*Response) (*Response, bool)
}

// QC is a quorum call invoked on all nodes in configuration c,
// with the same argument in, and returns a combined result.
func (c *Configuration[idType]) QC(ctx context.Context, in *Request) (resp *Response, err error) {
	cd := gorums.QuorumCallData[idType]{
		Message: in,
...
// with the same argument in, and returns a combined result.
func (n *Node[idType]) UnaryRPC(ctx context.Context, in *Request) (resp *Response, err error) {
	cd := gorums.CallData{
		Message: in,
