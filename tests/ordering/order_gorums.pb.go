...
func (srv *Server) QC(ctx gorums.ServerCtx, request *Request) (response *Response, err error) {
	panic(status.Errorf(codes.Unimplemented, "method QC not implemented"))
}
func (srv *Server) QCAsync(ctx gorums.ServerCtx, request *Request) (response *Response, err error) {
	panic(status.Errorf(codes.Unimplemented, "method QCAsync not implemented"))
}
func (srv *Server) UnaryRPC(ctx gorums.ServerCtx, request *Request) (response *Response, err error) {
	panic(status.Errorf(codes.Unimplemented, "method UnaryRPC not implemented"))
}

func RegisterGorumsTestServer(srv *Server, impl GorumsTestServer) {
