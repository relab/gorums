...
func (srv *Server) TestTLS(ctx gorums.ServerCtx, request *Request) (response *Response, err error) {
	panic(status.Errorf(codes.Unimplemented, "method TestTLS not implemented"))
}

func RegisterTLSServer(srv *Server, impl TLSServer) {
