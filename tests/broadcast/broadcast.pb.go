...
var file_broadcast_broadcast_proto_rawDesc = []byte{
	...
	0x6d, 0x70, 0x74, 0x79, 0x32, 0xa3, 0x07, 0x0a, 0x10, 0x42, 0x72, 0x6f, 0x61, 0x64, 0x63, 0x61,
	...
	0x6f, 0x6e, 0x73, 0x65, 0x22, 0x04, 0xb0, 0xb5, 0x18, 0x01, 0x42, 0x29, 0x5a, 0x27, 0x67, 0x69,
	0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x72, 0x65, 0x6c, 0x61, 0x62, 0x2f, 0x67,
	0x6f, 0x72, 0x75, 0x6d, 0x73, 0x2f, 0x74, 0x65, 0x73, 0x74, 0x73, 0x2f, 0x62, 0x72, 0x6f, 0x61,
...
var file_broadcast_broadcast_proto_depIdxs = []int32{
	...
	1,  // 14: broadcast.BroadcastService.QuorumCall:output_type -> broadcast.Response
	1,  // 15: broadcast.BroadcastService.QuorumCallWithBroadcast:output_type -> broadcast.Response
	1,  // 16: broadcast.BroadcastService.QuorumCallWithMulticast:output_type -> broadcast.Response
	2,  // 17: broadcast.BroadcastService.Multicast:output_type -> broadcast.Empty
	2,  // 18: broadcast.BroadcastService.MulticastIntermediate:output_type -> broadcast.Empty
	1,  // 19: broadcast.BroadcastService.BroadcastCall:output_type -> broadcast.Response
	2,  // 20: broadcast.BroadcastService.BroadcastIntermediate:output_type -> broadcast.Empty
	2,  // 21: broadcast.BroadcastService.Broadcast:output_type -> broadcast.Empty
	1,  // 22: broadcast.BroadcastService.BroadcastCallForward:output_type -> broadcast.Response
	1,  // 23: broadcast.BroadcastService.BroadcastCallTo:output_type -> broadcast.Response
	2,  // 24: broadcast.BroadcastService.BroadcastToResponse:output_type -> broadcast.Empty
	1,  // 25: broadcast.BroadcastService.Search:output_type -> broadcast.Response
	1,  // 26: broadcast.BroadcastService.LongRunningTask:output_type -> broadcast.Response
	1,  // 27: broadcast.BroadcastService.GetVal:output_type -> broadcast.Response
