...
var file_broadcast_broadcast_proto_rawDesc = []byte{
	...
	0x6d, 0x70, 0x74, 0x79, 0x32, 0xa8, 0x06, 0x0a, 0x10, 0x42, 0x72, 0x6f, 0x61, 0x64, 0x63, 0x61,
	...
	0x2e, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x04, 0xb0, 0xb5, 0x18, 0x01, 0x42,
...
var file_broadcast_broadcast_proto_depIdxs = []int32{
	...
	1,  // 12: broadcast.BroadcastService.QuorumCall:output_type -> broadcast.Response
	1,  // 13: broadcast.BroadcastService.QuorumCallWithBroadcast:output_type -> broadcast.Response
	1,  // 14: broadcast.BroadcastService.QuorumCallWithMulticast:output_type -> broadcast.Response
	2,  // 15: broadcast.BroadcastService.Multicast:output_type -> broadcast.Empty
	2,  // 16: broadcast.BroadcastService.MulticastIntermediate:output_type -> broadcast.Empty
	1,  // 17: broadcast.BroadcastService.BroadcastCall:output_type -> broadcast.Response
	2,  // 18: broadcast.BroadcastService.BroadcastIntermediate:output_type -> broadcast.Empty
	2,  // 19: broadcast.BroadcastService.Broadcast:output_type -> broadcast.Empty
	1,  // 20: broadcast.BroadcastService.BroadcastCallForward:output_type -> broadcast.Response
	1,  // 21: broadcast.BroadcastService.BroadcastCallTo:output_type -> broadcast.Response
	2,  // 22: broadcast.BroadcastService.BroadcastToResponse:output_type -> broadcast.Empty
	1,  // 23: broadcast.BroadcastService.Search:output_type -> broadcast.Response
