...
// BroadcastServiceClient is the client interface for the BroadcastService service.
type BroadcastServiceClient interface {
	QuorumCall(ctx context.Context, in *Request) (resp *Response, err error)
	QuorumCallWithBroadcast(ctx context.Context, in *Request) (resp *Response, err error)
	QuorumCallWithMulticast(ctx context.Context, in *Request) (resp *Response, err error)
	Multicast(ctx context.Context, in *Request, opts ...gorums.CallOption)
	MulticastIntermediate(ctx context.Context, in *Request, opts ...gorums.CallOption)
	BroadcastCall(ctx context.Context, in *Request, cancelOnTimeout ...bool) (resp *Response, err error)
	BroadcastCallForward(ctx context.Context, in *Request, cancelOnTimeout ...bool) (resp *Response, err error)
	BroadcastCallTo(ctx context.Context, in *Request, cancelOnTimeout ...bool) (resp *Response, err error)
	Search(ctx context.Context, in *Request, cancelOnTimeout ...bool) (resp *Response, err error)
	LongRunningTask(ctx context.Context, in *Request, cancelOnTimeout ...bool) (resp *Response, err error)
	GetVal(ctx context.Context, in *Request, cancelOnTimeout ...bool) (resp *Response, err error)
	Order(ctx context.Context, in *Request, cancelOnTimeout ...bool) (resp *Response, err error)
}

// enforce interface compliance
var _ BroadcastServiceClient = (*Configuration)(nil)
...
func RegisterBroadcastServiceServer(srv *Server, impl BroadcastServiceServer) {
