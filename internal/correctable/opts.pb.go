...
var (
	file_internal_correctable_opts_proto_rawDescOnce sync.Once
	file_internal_correctable_opts_proto_rawDescData = file_internal_correctable_opts_proto_rawDesc
)

func file_internal_correctable_opts_proto_rawDescGZIP() []byte {
	file_internal_correctable_opts_proto_rawDescOnce.Do(func() {
		file_internal_correctable_opts_proto_rawDescData = protoimpl.X.CompressGZIP(file_internal_correctable_opts_proto_rawDescData)
	})
	return file_internal_correctable_opts_proto_rawDescData
}
