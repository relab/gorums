...
func (c *Configuration) asyncQuorumCall(ctx context.Context, in *Request, resp *FutureResponse, opts ...grpc.CallOption) {
	var ti traceInfo
	if c.mgr.opts.trace {
		ti.Trace = trace.New("gorums."+c.tstring()+".Sent", "AsyncQuorumCall")
		defer ti.Finish()
	...
	for {
		...
		case r := <-replyChan:
			...
			if reply, quorum = c.qspec.AsyncQuorumCallQF(in, replyValues); quorum {
...
type QuorumSpec interface {
	...
	AsyncQuorumCallQF(in *Request, replies []*Response) (*Response, bool)
}
