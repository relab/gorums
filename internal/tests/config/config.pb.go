...
const file_config_config_proto_rawDesc = "" +
	...
	"\n" +
	"ConfigTest\x121\n" +
	"\x06Config\x12\x0f.config.Request\x1a\x10.config.Response\"\x04\xa0\xb5\x18\x01B5\x8a\xc4\x13\x06uint32Z$github.com/relab/gorums/tests/config\x92\x03\x02\b\x02b\beditionsp\xe8\a"
