...
const file_config_config_proto_rawDesc = "" +
	...
	"\n" +
	"ConfigTest\x12/\n" +
	"\x04Read\x12\x0f.config.Request\x1a\x10.config.Response\"\x04\xa0\xb5\x18\x01B+Z$github.com/relab/gorums/tests/config\x92\x03\x02\b\x02b\beditionsp\xe8\a"
...
var file_config_config_proto_depIdxs = []int32{
	0, // 0: config.ConfigTest.Read:input_type -> config.Request
	1, // 1: config.ConfigTest.Read:output_type -> config.Response
