...
type UnresponsiveServer interface {
	TestUnresponsive(gorums.ServerContext, *Empty) (*Empty, error)
}

func RegisterUnresponsiveServer(srv *gorums.Server, impl UnresponsiveServer) {
	srv.RegisterHandler("unresponsive.Unresponsive.TestUnresponsive", func(ctx gorums.ServerContext, in *gorums.Message) (*gorums.Message, error) {
