...
const currentProtocVersion = "3.5.0"
...
func TestEndToEnd(t *testing.T) {
	if !version.AtLeast(currentProtocVersion) {
		t.Skipf("skipping test due to old protoc version, got %q, required is at least %q", version.Get(), currentProtocVersion)
	}
