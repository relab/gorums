...
func (m *Manager) read(ctx context.Context, c *Configuration, args *Key) (*ReadReply, error) {
...
func (m *Manager) write(ctx context.Context, c *Configuration, args *Value) (*WriteReply, error) {
