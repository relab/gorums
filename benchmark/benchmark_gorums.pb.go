...
type BenchmarkClient interface {
	StartServerBenchmark(ctx context.Context, in *StartRequest) iter.Seq2[*StartResponse, error]
	StopServerBenchmark(ctx context.Context, in *StopRequest) iter.Seq2[*Result, error]
	StartBenchmark(ctx context.Context, in *StartRequest) iter.Seq2[*StartResponse, error]
	StopBenchmark(ctx context.Context, in *StopRequest) iter.Seq2[*MemoryStatList, error]
	QuorumCall(ctx context.Context, in *Echo) iter.Seq2[*Echo, error]
	AsyncQuorumCall(ctx context.Context, in *Echo) *AsyncEcho
	SlowServer(ctx context.Context, in *Echo) iter.Seq2[*Echo, error]
...
// with the same argument in, and returns a combined result.
func (c *Configuration) StartServerBenchmark(ctx context.Context, in *StartRequest) iter.Seq2[*StartResponse, error] {
	cd := gorums.QuorumCallData{
		Message: in,
...
// with the same argument in, and returns a combined result.
func (c *Configuration) StopServerBenchmark(ctx context.Context, in *StopRequest) iter.Seq2[*Result, error] {
	cd := gorums.QuorumCallData{
		Message: in,
...
// with the same argument in, and returns a combined result.
func (c *Configuration) StartBenchmark(ctx context.Context, in *StartRequest) iter.Seq2[*StartResponse, error] {
	cd := gorums.QuorumCallData{
		Message: in,
...
// with the same argument in, and returns a combined result.
func (c *Configuration) StopBenchmark(ctx context.Context, in *StopRequest) iter.Seq2[*MemoryStatList, error] {
	cd := gorums.QuorumCallData{
		Message: in,
		Method:  "benchmark.Benchmark.StopBenchmark",
	}

	return gorums.QuorumCall[*MemoryStatList](ctx, c.RawConfiguration, cd)
}

// benchmarks
func (c *Configuration) QuorumCall(ctx context.Context, in *Echo) iter.Seq2[*Echo, error] {
	cd := gorums.QuorumCallData{
		Message: in,
...
// with the same argument in, and returns a combined result.
func (c *Configuration) SlowServer(ctx context.Context, in *Echo) iter.Seq2[*Echo, error] {
	cd := gorums.QuorumCallData{
		Message: in,
