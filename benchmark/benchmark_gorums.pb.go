...
func (c *Configuration) AsyncQuorumCall(ctx context.Context, in *Echo, opts ...gorums.CallOption) *AsyncEcho {
...
// with the same argument in, and returns a combined result.
func (c *Configuration) StopBenchmark(ctx context.Context, in *StopRequest, opts ...gorums.CallOption) (resp *MemoryStatList, err error) {
	cd := gorums.QuorumCallData{
		Message: in,
