...
const file_benchmark_benchmark_proto_rawDesc = "" +
	...
	"\vMemoryStats\x18\x01 \x03(\v2\x15.benchmark.MemoryStatR\vMemoryStats2\x9c\x04\n" +
	"\tBenchmark\x12O\n" +
	...
	"\n" +
	"QuorumCall\x12\x0f.benchmark.Echo\x1a\x0f.benchmark.Echo\"\x04\xa0\xb5\x18\x01\x129\n" +
	"\x0fAsyncQuorumCall\x12\x0f.benchmark.Echo\x1a\x0f.benchmark.Echo\"\x04\xa0\xb5\x18\x01\x124\n" +
	"\n" +
