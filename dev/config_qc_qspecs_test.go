...
func (*ReadTwoTestQSpec) ReadFutureQF(replies []*qc.State) (*qc.State, bool) {
	panic("not implemented")
}
...
func (*ReadTwoTestQSpec) WriteFutureQF(req *qc.State, replies []*qc.WriteResponse) (*qc.WriteResponse, bool) {
	panic("not implemented")
}
