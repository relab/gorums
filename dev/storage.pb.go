...
type StorageClient interface {
	...
	WriteAdapter(ctx context.Context, in *MyState, opts ...grpc.CallOption) (*WriteResponse, error)
}
...
func (c *storageClient) ReadCorrectableStream(ctx context.Context, in *ReadRequest, opts ...grpc.CallOption) (Storage_ReadCorrectableStreamClient, error) {
	stream, err := grpc.NewClientStream(ctx, &_Storage_serviceDesc.Streams[0], c.cc, "/dev.Storage/ReadCorrectableStream", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *storageClient) WriteAdapter(ctx context.Context, in *MyState, opts ...grpc.CallOption) (*WriteResponse, error) {
	out := new(WriteResponse)
	err := grpc.Invoke(ctx, "/dev.Storage/WriteAdapter", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type StorageServer interface {
	...
	// Note that the client-provided type may be the same as the server-side type,
	// i.e. gorums.adapter could also be "MyState".
	WriteAdapter(context.Context, *MyState) (*WriteResponse, error)
}
...
func _Storage_WriteAdapter_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(MyState)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(StorageServer).WriteAdapter(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/dev.Storage/WriteAdapter",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(StorageServer).WriteAdapter(ctx, req.(*MyState))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _Storage_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "WriteAdapter",
			Handler:    _Storage_WriteAdapter_Handler,
		},
	},
...
var fileDescriptorStorage = []byte{
	...
	,
}
