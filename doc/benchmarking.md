...
The program is compiled from `benchkit/cmd/benchmark`, and uses the `benchkit/benchmark` package.
...
```text
Usage of benchkit/cmd/benchmark/benchmark:
  -benchmarks regexp
...
By default, the `benchkit/cmd/benchmark` program starts internal servers to perform benchmarks locally.
