...
By default, tests use in-memory bufconn connections for fast, reliable execution:
...
| `test`            | Run Gorums tests (using bufconn by default).                                 |
| `integrationtest` | Run integration tests with real TCP connections.                             |
